...
$result = mysql_query("INSERT INTO customers (cusno, name, oname, lname, phone) VALUES ('".$cusno."','".$name."','".$oname."','".$lname."','".$phone."')")  or die (mysql_error());
$resulta = mysql_query("insert into creditcustomers values('".$cusno."','".$fullname."','".$phone."','0')");										
if($result){
$resulta = mysql_query("insert into log values('0','".$username." creates new Customer.Code:".$cusno."','".$username."','".date('YmdHi')."','".date('H:i')."','".date('d/m/Y')."','1')");   
echo '<script>swal("Success!", "Customer added!", "success");</script>';
}
else {
echo '<script>swal("Error", "Customer not added!", "error");</script>';
}
...
$result = mysql_query("update customers set name='".$name."',oname='".$oname."',lname='".$lname."',phone='".$phone."' where cusno=".$cusno."");
$resulta = mysql_query("update creditcustomers set name='".$fullname."',phone='".$phone."' where CustomerId=".$cusno."");									
if($result){
$resulta = mysql_query("insert into log values('0','".$username." updates Customer information.Code:".$cusno."','".$username."','".date('YmdHi')."','".date('H:i')."','".date('d/m/Y')."','1')");   
echo '<script>swal("Success!", "Customer information updated!", "success");</script>';
}
else {
echo '<script>swal("Error", "Customer information not updated!", "error");</script>';
}
